...
async function PrivateSetting(WorkData, Row) {
  try {
    ...
    for (let i = 0; i <= 29; i++) {
      // const VideoTitle = await RPA.WebBrowser.wait(
      //   RPA.WebBrowser.Until.elementLocated({
      //     xpath: `/html/body/ytcp-app/ytcp-entity-page/div/div/main/div/ytcp-animatable[30]/ytcp-video-section/ytcp-video-section-content/div/ytcp-video-row[${Number(
      //       i
      ...
      if (VideoTitleText != WorkData[0][0][3]) {
        ...
        //         i
        //       )}]/div/div[2]/ytcp-video-list-cell-video/div[1]/a`
        //     )
        //   )
        //   .getAttribute('href');
